 ...
 * 
 * <p><b>Copyright 2008-2015, GreenSock. All rights reserved.</b> This work is subject to the terms in <a href="http://www.greensock.com/standard-license/">http://www.greensock.com/standard-license/</a> or for <a href="http://www.greensock.com/club/">Club GreenSock</a> members, the software agreement that was issued with the membership.</p>
 * 
 ...
 */
	public class TransformAroundPointPlugin extends TweenPlugin {
		...
		private static function _applyMatrix(p:Point, m:Matrix):Point {
			...
			var dec:Number;
			x = (dec = x - (x |= 0)) ? (dec < 0.3 ? 0 : dec < 0.7 ? 0.5 : 1) + x : x; //we must round to the nearest 0.5 to avoid drifting.
			y = (dec = y - (y |= 0)) ? (dec < 0.3 ? 0 : dec < 0.7 ? 0.5 : 1) + y : y;
