package {
	...
	public class Particles extends MovieClip 
	{
		...
		public function Particles() 
		{
			...
			this.addEventListener(Event.ENTER_FRAME, FadeOutParticles);
		}

		public function FadeOutParticles(e:Event) {
			...
			if (this.alpha<0) 
			{
				this.removeEventListener(Event.ENTER_FRAME, FadeOutParticles);
